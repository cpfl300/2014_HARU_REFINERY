package refinery.scheduler.config;
...
@Configuration
@ComponentScan(basePackages={"refinery.config", "refinery.scheduler"})
@PropertySource(value="classpath:application-properties.xml")
@EnableTransactionManagement
public class RefinerySchedulerConfig {
	
	private static final Logger log = LoggerFactory.getLogger(RefinerySchedulerConfig.class);
